...
#     rotation_map_rad = np.array(rotation_map_rad, dtype=float)
#     f = interpolate.RegularGridInterpolator((x, y), rotation_map_rad, method='linear')
...
def get_hand_orientation(hand_loc, forearm_length):
    ...
    # Coordinate grid (matches 31x31 grid: -1.5 to 1.5 by 0.1)
