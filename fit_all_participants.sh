...
#SBATCH --array=1-14
#SBATCH --output=/home/xiangyz/ondemand/data/sys/myjobs/projects/uist-26/simulation-for-webGUI-evaluation/logs/fit_%A_%a.out
#SBATCH --error=/home/xiangyz/ondemand/data/sys/myjobs/projects/uist-26/simulation-for-webGUI-evaluation/logs/fit_%A_%a.err
...
echo "Fitting participant: $PID (array task $SLURM_ARRAY_TASK_ID)"
echo "Start time: $(date)"

python -m eval.model_fitting.fit_speed_model \
    --pid "$PID" \
    --time-limit 43200 \
    --seed 42 \
    2>&1 | tee "eval/model_fitting/results/fit_${PID}_s42.log"
